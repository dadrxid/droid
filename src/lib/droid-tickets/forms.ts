...
export const TICKET_FORMS: Record<TicketKind, TicketForm> = {
  custom: {
    ...
    inputs: [
      ...
      {
        id: 'theme',
        label: 'Colour or theme ideas',
        paragraph: false,
        required: false,
        max: 100,
        placeholder: 'e.g. clear black, mint, anime shell',
      },
      {
        id: 'have',
      ...
      {
        id: 'where',
        label: 'Country or postcode for postage',
        paragraph: false,
        required: true,
        max: 60,
        placeholder: 'e.g. TS1, UK',
      },
      {
        id: 'extra',
        ...
        required: false,
        max: 500,
        placeholder: 'Deadlines, budget, links to photos',
      },
    ],
  },
  repair: {
